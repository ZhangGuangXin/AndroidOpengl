package com.example.opengldemo.shadowMapping;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

import com.example.opengldemo.R;
import com.example.opengldemo.shadowMapping.common.FPSCounter;
import com.example.opengldemo.shadowMapping.common.RenderConstants;
import com.example.opengldemo.shadowMapping.common.RenderProgram;
...
public class ShadowsRenderer implements GLSurfaceView.Renderer {
    ...
    private final ShadowMappingtDemoActivity mShadowsActivity;
...
//	private boolean mHasDepthTextureExtension = false;
	...
	public ShadowsRenderer(final ShadowMappingtDemoActivity shadowsActivity) {
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Matrix.frustumM(mProjectionMatrix, 0, -ratio, ratio, 
        		bottom, top, near, far);
//        mLightProjectionMatrix = mProjectionMatrix;
        Matrix.frustumM(mLightProjectionMatrix, 0, -ratio, ratio,
        	    bottom, top, near, far);  
    }
