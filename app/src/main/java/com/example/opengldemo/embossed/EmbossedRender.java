...
@SuppressLint("NewApi")
public class EmbossedRender extends BasicRender {
	...
	public EmbossedRender(Activity activity) {
	...
	public void onSurfaceCreated(GL10 arg0, EGLConfig arg1) {
		...
		textureShader = new BasicShaderProgram(activity, R.raw.rotate_vertex_shader, R.raw.embossed_fragment);
