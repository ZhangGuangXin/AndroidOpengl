...
@SuppressLint("NewApi")
public class AntiAliasinglRender extends BasicRender {
	...
	public AntiAliasinglRender(Activity activity) {
	...
	public void onSurfaceCreated(GL10 arg0, EGLConfig arg1) {
		...
		textureShader = new BasicShaderProgram(activity, R.raw.rotate_vertex_shader, R.raw.anti_aliasing_fragment);
