 ...
 */
public class CommonShaderProgram extends BasicShaderProgram {
    ...
    public CommonShaderProgram(Context context, int vertexShaderResourceId, int fragmentShaderResourceId) {
