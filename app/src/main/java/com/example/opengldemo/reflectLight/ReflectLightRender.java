...
import com.example.opengldemo.pointLight.PointLightShaderProgram;
...
@SuppressLint("NewApi")
public class ReflectLightRender extends BasicRender {
	...
	private PointLightShaderProgram textureShader;
	private Vertices3 mesh;
	private float xAngle = 0;
	private float yAngle = 0;

	public ReflectLightRender(Activity activity) {
	...
	public void onSurfaceCreated(GL10 arg0, EGLConfig arg1) {
		...
		textureShader = new PointLightShaderProgram(activity,
	...
	private void drawMesh(){
		...
		float[] pointLight = {2f, 2f, 1.0f, 1.0f};
	...
	private float[] getMeshMatrix() {
		...
		Matrix.translateM(modelMatrix, 0, 0f, -2f, -2.5f);
